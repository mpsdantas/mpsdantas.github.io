...
// Step 1 - To interact with instagram’s API you will need to create an API KEY, which you can create at: https://dev.instagram.com/apps
...
$instagram_screen_name = $_GET['instagram_screen_name'];
...
$TweetPHP = new TweetPHP(array(
	...
	'instagram_screen_name'   => $instagram_screen_name,
	'cache_file'            => dirname(__FILE__) . '/tweet-php/cache/instagram.txt', // Where on the server to save the cached formatted tweets
	'cache_file_raw'        => dirname(__FILE__) . '/tweet-php/cache/instagram-array.txt', // Where on the server to save the cached raw tweets
	'cachetime'             => 60, // Seconds to cache feed
	'tweets_to_display'     => $tweets_to_display, // How many tweets to fetch
	'ignore_replies'        => true, // Ignore @replies
	'ignore_retweets'       => true, // Ignore retweets
	'instagram_style_dates'   => true, // Use instagram style dates e.g. 2 hours ago
	...
	'instagram_wrap_open'     => '<ul>',
	'instagram_wrap_close'    => '</ul>',
	'tweet_wrap_open'       => '<li><span class="status"><i class="fa fa-instagram"></i> ',
